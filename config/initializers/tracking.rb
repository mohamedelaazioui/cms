...
Rails.application.config.tracking = {
  google_analytics: ENV.fetch('GOOGLE_ANALYTICS_ID', 'GA_MEASUREMENT_ID'),
  facebook_pixel: ENV.fetch('FACEBOOK_PIXEL_ID', 'YOUR_FACEBOOK_PIXEL_ID'),
